    ...
    <View style={[styles.container, { paddingBottom: insets.bottom + 32 }]}>
      <View style={styles.empty}>
        <View style={styles.iconWrap}>
          <MaterialIcons name="bar-chart" size={52} color={BRAND.primary} />
        </View>
        <Text style={styles.title}>Reports & Analytics</Text>
        <Text style={styles.subtitle}>Business performance, pipeline health,{'\n'}and disbursement summaries.</Text>
