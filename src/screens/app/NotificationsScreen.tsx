    ...
    <View style={[styles.container, { paddingBottom: insets.bottom + 32 }]}>
      <View style={styles.empty}>
        <View style={styles.iconWrap}>
          <MaterialIcons name="notifications-none" size={52} color={BRAND.primary} />
        </View>
        <Text style={styles.title}>Notifications</Text>
        <Text style={styles.subtitle}>Stay updated with lead status changes,{'\n'}task reminders, and approvals.</Text>
        <View style={styles.chip}><Text style={styles.chipText}>No new notifications</Text></View>
      </View>
    </View>
  );
}
