    ...
    <View style={[styles.container, { paddingBottom: insets.bottom + 32 }]}>
      <View style={styles.empty}>
        <View style={styles.iconWrap}>
          <MaterialIcons name="settings" size={52} color={BRAND.primary} />
        </View>
        <Text style={styles.title}>Settings</Text>
        <Text style={styles.subtitle}>Manage app preferences, roles,{'\n'}integrations, and system configuration.</Text>
        <View style={styles.chip}><Text style={styles.chipText}>Admin Only</Text></View>
      </View>
    </View>
  );
}
