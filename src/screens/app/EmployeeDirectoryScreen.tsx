    ...
    <View style={[styles.container, { paddingBottom: insets.bottom + 32 }]}>
      <View style={styles.empty}>
        <View style={styles.iconWrap}>
          <MaterialIcons name="contacts" size={52} color={BRAND.primary} />
        </View>
        <Text style={styles.title}>Employee Directory</Text>
        <Text style={styles.subtitle}>Search and contact team members,{'\n'}view org chart and reporting lines.</Text>
